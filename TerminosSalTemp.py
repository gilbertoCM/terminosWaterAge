...
terminos_sal_temp_SEMAR = terminos_sal_temp_SEMAR.set_index(
    terminos_sal_temp_SEMAR["Date_GMT_00"])
...
mask = (terminos_sal_temp_SEMAR["Date_GMT_00"] > start_date) & (
    terminos_sal_temp_SEMAR["Date_GMT_00"] <= end_date)
...
terminos_sal_temp_SEMAR_2017['Salinity_psu_daily'] = terminos_sal_temp_SEMAR_2017["Salinity_psu"].resample(
    'D').mean()
...
terminos_sal_temp_SEMAR_2017['Temp_C_daily'] = terminos_sal_temp_SEMAR_2017["Temp_C"].resample(
    'D').mean()
